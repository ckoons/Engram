...
logger = logging.getLogger("cmb.structured_memory")
...
class StructuredMemory:
    ...
    def __init__(self, client_id: str = "default", data_dir: Optional[str] = None):
        ...
        Args:
            ...
            data_dir: Directory to store memory data (default: ~/.cmb/structured)
        """
        ...
        if data_dir:
            ...
            self.base_dir = Path(os.path.expanduser("~/.cmb/structured"))
