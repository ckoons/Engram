#!/usr/bin/env python3
"""
Simple Claude to Llama Message Sender

This script allows Claude to send messages to Llama and read Llama's responses.
"""
...
async def get_responses(limit=5):
    """Get responses from Llama."""
    responses = await k("Llama_to_Claude")
    ...
    if responses:
        ...
        print("\nNo messages from Llama found.")

async def chat_loop():
    """Run the chat loop."""
    print("\n=== Claude to Llama Chat ===")
